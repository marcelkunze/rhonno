...
public:
    ...
    static int samepart(treePoint &a, treePoint &b);
    ...
    static double* recallPair(treePoint &p1, treePoint &p2);
    static double* recall3(Point &p1, Point &p2, Point &p3);
    static double* recallTriple(treePoint &p1, treePoint &p2, treePoint &p3);
    ...
    static int good_pair(treePoint &a, treePoint &b);
    static double dir_miss(treePoint &a, treePoint &b);
    static bool getFeatures3(treePoint &a, treePoint &b, float *feature);
    static double wdistr(double r1, double dr, double az, double dz, double w);
    static double wdist(Point &a, Point &b, double w);
